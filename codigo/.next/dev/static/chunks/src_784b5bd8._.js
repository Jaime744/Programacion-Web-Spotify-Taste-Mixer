...
function DecadeWidget({ accessToken }) {
    _s();
    const [decade, setDecade] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])('');
    ...
    const handleSearch = async ()=>{
        if (decade) {
            try {
                const response = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].get(`https://api.spotify.com/v1/search?type=track&q=year:${decade}`, {
                    headers: {
                        Authorization: `Bearer ${accessToken}`
                    }
                });
...
_s(DecadeWidget, "JZnlRvKMcT8BwYfAJ28SQzkb5iY=");
_c = DecadeWidget;
var _c;
...
//# sourceMappingURL=src_784b5bd8._.js.map